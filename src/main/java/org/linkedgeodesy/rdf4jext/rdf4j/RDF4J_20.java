...
import org.linkedgeodesy.rdf4j.exceptions.SparqlParseException;
import org.linkedgeodesy.rdf4j.exceptions.SparqlQueryException;
...
public class RDF4J_20 {
    ...
    public static int getNumberOfStatements(String repositoryID, String rdf4jServer) throws MalformedURLException, IOException, SparqlQueryException {
        try {
